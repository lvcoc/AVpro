...
namespace UnityEngine.UI.Extensions {
    ...
    public class TFTRadarChart : MaskableGraphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            Vector2 size = GetComponent<RectTransform>().rect.size / 2;
           ...
           // Debug.Log(pos[0].localPosition);
            //vh.AddVert(new Vector3(0, 0), Color.red, Vector2.zero); vh.AddVert(new Vector3(0, 100), Color.green, Vector2.zero); vh.AddVert(new Vector3(100, 100), Color.black, Vector2.zero); vh.AddVert(new Vector3(100, 0), Color.blue, Vector2.zero);
