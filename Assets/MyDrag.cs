    ...
    IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Update()
    {
        Vector2 pos = new Vector2(Mathf.Clamp(imgRect.localPosition.x,-400,400), Mathf.Clamp(imgRect.localPosition.y, -150, 150));
    ...
    {
        Vector2 _prevPosition = mouseDrag;
        mouseDrag = eventData.position;   //当鼠标拖动时的屏幕坐标
        _velocity = mouseDrag - _prevPosition;
